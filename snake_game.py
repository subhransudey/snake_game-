...
font1 = pygame.font.SysFont(None,50,bold= False,italic=False)


def on_screen_text(text,font,color,x,y):
...
def welcome_screen():
    ...
    while not  exit_game :
        ...
        on_screen_text("Welcome to SnakeWithSubhransu",font1,white,16,260)
        on_screen_text("Press Space To Continue",font1,yellow,90,300)
...
def gameloop():
    ...
    food_y = random.randint(40, screen_height)
    food_size = 10
    ...
    while not  exit_game:
        ...
        if game_over :
            ...
            on_screen_text("Game Over ! ",font1,red,165 ,250)
            on_screen_text("Press Enter To Continue",font1,red,75,305)
            ...
            if abs(snake_x - food_x) < 10 and abs(snake_y- food_y)<10:
                ...
                food_x = random.randint(0, screen_width)
                food_y = random.randint(0, screen_height*0.75)
            ...
            pygame.draw.rect(game_window, blue, [food_x, food_y, food_size, food_size]) # plotting foods in game window
            on_screen_text(f"score : {score}    high score : {highscore}",font1, red, 5, 5)# to show on screen score
        pygame.display.update()
        clock.tick(fps)
